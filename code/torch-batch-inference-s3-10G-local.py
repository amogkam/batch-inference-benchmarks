...
# Create and broadcast model state to all executors
...
# Repartition to 1 to limit parallelism for GPU prediction.
...
predictions = one_partition_data.select(predict(col("preprocess(image)")))
